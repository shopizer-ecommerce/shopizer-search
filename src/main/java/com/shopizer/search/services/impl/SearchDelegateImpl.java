...
public class SearchDelegateImpl implements SearchDelegate {
  ...
  public SearchResponse search(SearchRequest request) throws Exception {
    ...
    List<com.shopizer.search.services.SearchHit> hits =
    ...
    while (elementsIterator.hasNext()) {
      ...
      com.shopizer.search.services.SearchHit hit =
          new com.shopizer.search.services.SearchHit(item, _id);
      hits.add(hit);
      ...
      if (CollectionUtils.isNotEmpty(aggregationList)) {
        for (String agg : aggregationList) {
          ...
          if (terms != null) {
            ...
            List<com.shopizer.search.services.Entry> facetEntries =
                new ArrayList<com.shopizer.search.services.Entry>();
